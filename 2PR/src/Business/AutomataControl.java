...
public class AutomataControl {
    ...
    //Constructor
    public AutomataControl(String pDirectoryPath, String pUserPattern) {
            ...
            for(int tokenIndex = 0; tokenIndex < tokenList.length; tokenIndex++){
                ...
                if(tokenPrepared.length() >= _PatternHead.length()+_PatternTail.length()+1){
                    ...
                    for(int indexOfOption = 1; indexOfOption < tokenOpcional.length; indexOfOption++){
                        ...
                        int matchedToken = AutomataMethod(this._PatternHead + tokenOpcional[indexOfOption] + this._PatternTail, tokenPrepared, pDirectoryName, pFileName, fileLineNumber);
    ...
    public int AutomataMethod(String patternOption, String pToken, String pDirectoryName, String pFileName, int pFileLine){
